...
public class DigitalStorm extends BuildPC {
    private double discount = 29.0; // this variable is private which mean it can only be accessible in it own class.
    private static double price = 1300.0; // only static methods, class can access the static fields, since its also private that means this variable is only useable in this class
    public int code = 3; // A public field can be accessed by other classes and methods outside of its own class. Only if if the class is object is created.
    protected String Description = "Digital Storm is a privately owned boutique computer manufacturer in the United States that primarily specializes on high-performance gaming desktop and laptop computers. ";
    ...
    public void getCode()
    {
        System.out.println("Secret code for DigitalStorm received from Generic Class ");
    }
    ...
    @Override
    void information() {
        System.out.println("Digital Storm Is building Ram, Cpu, Graphics Card, and SSD. Please Wait.....");
    }

    // We are implementing an abstract method from buildPC abstract class
    @Override
    public String buildRam() {
        return "Ram has been Build from Digital Storm Parent Class";
    }
...
//-----------------------------------------------------------------------------
    ...
    public void Message()
    {
        System.out.println("you got 29% basic discount");
    }
    //-----------------------------------------------------------------------------------
    //----------------------------------------------------------------------------------
    ...
    static class newPrice extends DigitalStorm implements InterFace.nestedInterFace
    {
        private double discount = 35.0; // this variable will overshadow its parent class variable if this class object is created.


        public newPrice()
        {
            System.out.println("Variable of discount in DigitalStorm has been overshadowed, discount is " + discount);
        }

        // This method is created to show and example of "overriding method"
        // The same method is created in its parent class DigitalStorm
        @Override
        public double afterDiscount() {
            float totalPrice = (float) (price - discount);
            return totalPrice;
        ...
        public void Message()
        {
            ...
            System.out.println("Congrats! you got 35% basic discount");
        }
